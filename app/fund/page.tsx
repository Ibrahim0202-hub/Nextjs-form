            ...
            <div className="h-44 md:h-56">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                  ...
                  <YAxis domain={[0, 150]} tickLine={false} axisLine={false} tick={{ fontSize: 11 }} />
                  <Tooltip />
            ...
            {allFunds.filter(f => f.id !== fund?.id).map((f) => (
              <div key={f.id} className="border border-gray-100 rounded-xl p-3 mb-3 flex items-center justify-between gap-3">
                <div className="flex-1">
                  ...
                  <button onClick={() => router.push("/fund")} className="mt-3 bg-black text-white rounded-full px-4 h-8 text-[11px]">Invest Now</button>
                </div>
